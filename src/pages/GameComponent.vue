...
export default {
  setup() {
    ...
    const hoverDivisor = (index) => { // Check it is a division question
      if (currentQuestion.value.operator === "÷") { // While hovering, group all the different values calculated above and show user.
        hoverIndex.value = index;
      }
    };
    const clearHover = () => { // Once user removes cursor from denominator, remove the groupings.
