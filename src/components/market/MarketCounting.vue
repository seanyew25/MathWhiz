  ...
  >
    ...
    >
      ...
      >
        ...
        <h3
          class="tw-text-3xl tw-mb-4 tw-flex tw-justify-center tw-items-center tw-gap-4"
        >
        ...
        >
          ...
          >
            ...
            <p class="tw-text-lg tw-mb-4">
              In Hint Mode, click items to preview them in the target box with a
              counter.<br />Do you want to turn on Hint Mode?
            </p>

            <!-- Buttons -->
            <div class="tw-flex tw-gap-8 tw-justify-center">
              <button @click="getHint(true)" class="nes-btn is-success tw-w-32">
                Yes
              </button>
              <button @click="getHint(false)" class="nes-btn is-error tw-w-32">
                No
              </button>
            </div>
          </div>
        ...
        <div class="grid-container">
          <div v-for="(grid, index) in grids" :key="index" class="grid-item">
            ...
            <p class="tw-text-center tw-mt-3 tw-text-base">
              {{ labels[index] }}
            </p>
          </div>
        </div>
    ...
    <div v-if="gameOver" class="game-over-overlay">
      <div class="game-over-content nes-container is-rounded">
        ...
        <div class="button-container">
          <button @click="exitGame" class="nes-btn is-primary">Exit</button>
