<template>
  ...
  >
    ...
    <div
      ...
      style="background-color: rgba(255, 245, 205, 1); width: 768px"
    >
      <p class="title" style="background-color: rgba(255, 245, 205, 1)">
        Counting
      </p>
      <div
        class="tw-max-w-3xl tw-flex tw-flex-col tw-items-center tw-justify-center"
      >
        <!-- Instructions and Hint Button -->
        <h3
          class="tw-text-3xl tw-mb-2 tw-flex tw-justify-center tw-items-center tw-gap-4"
        >
          ...
          <button
            @click="
              ...
              timerFrozen = true;
            "
            class="nes-btn is-primary tw-text-sm tw-mx-2"
          >
            Hint
          </button>
        </h3>
        ...
        >
          ...
          >
            ...
            <p class="tw-text-md tw-mb-4">
              In Hint Mode, click on the items to see how they add up in the
              box.<br /><br />
            ...
            <div class="tw-flex tw-gap-8 tw-justify-center">
              <button
                @click="
                  ...
                  timerFrozen = false;
                "
                class="nes-btn is-success tw-w-32"
              >
                Yes
              </button>
              <button
                @click="
                  ...
                  timerFrozen = false;
                "
                class="nes-btn is-error tw-w-32"
              >
                No
              </button>
            </div>
        ...
        <transition name="fade">
          <div
            v-if="streakCount >= 5"
            class="streak-banner text-center my-2 tw-flex tw-items-center tw-justify-center"
          >
        ...
        <div class="grid-container tw-mb-4">
          <div v-for="(grid, index) in grids" :key="index" class="grid-item">
            <p class="tw-text-center tw-mt-2 tw-mb-0 tw-text-base">
              {{ labels[index] }}
            </p>
            <div class="object-grid">
              <div
                v-for="object in grid"
                :key="object.id"
              ...
              >
                <img
                  :src="object.image"
                  :alt="object.type"
                  class="tw-w-full tw-h-full object-contain"
                />
              </div>
            </div>
          </div>
        ...
        <div class="tw-flex tw-justify-center tw-gap-8 tw-mt-0">
          <div
            ref="hundredsBox"
            class="target-box nes-container is-rounded tw-bg-white"
            style="padding: 8px"
          ></div>
          <div
            ref="tensBox"
  ...
  setup() {
    ...
    const handleHundredsAnimation = () => {
      ...
      animateItems(hundredsGroup, "hundreds", () => {
        const selectedTotal = objects.value.reduce(
          (sum, obj) => (obj.selected ? sum + obj.value : sum),
          0
        );
    ...
    onBeforeUnmount(() => {
      ...
      document.querySelectorAll("img[data-ghost]").forEach((el) => el.remove());
      document
        .querySelectorAll(".tw-count-overlay")
        .forEach((el) => el.remove());
      document
        .querySelectorAll(".tw-temp-counter-overlay")
        .forEach((el) => el.remove());
    });
