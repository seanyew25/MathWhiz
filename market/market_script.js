...
// Conditionally mounting components based on page URL
const url = window.location.pathname;

if (url.includes("cutscene.html")) {
  // Mount the Cutscene component
  const app = createApp({
    components: {
      Cutscene,
    },
...
} else if (url.includes("counting.html")) {
  // Mount the Counting component
  const app = createApp({
    components: {
      Counting,
    },
